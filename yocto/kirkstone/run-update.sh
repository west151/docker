...
if ! [ -d $(pwd)/poky ];
 then
   ...
   echo
   git clone -b $YOCTO_BRANCH git@github.com:west151/meta-snake-cm4-qt6.git poky/meta-snake-cm4-qt6
   echo
   ...
   # meta-snake-cm4-qt6
   echo
   echo -e "${CL_YELLOY}update meta-snake-cm4-qt6:${CL_NC}" $YOCTO_BRANCH
   if ! [ -d $(pwd)/poky/meta-snake-cm4-qt6 ];
     then
       git -C poky clone -b $YOCTO_BRANCH git@github.com:west151/meta-snake-cm4-qt6.git
     else
       git -C poky/meta-snake-cm4-qt6 fetch && git -C poky/meta-snake-cm4-qt6 pull origin
   fi
   # meta-openembedded
   echo
...
cp poky/meta-snake-cm4-qt6/conf/bblayers.conf.docker build/conf/bblayers.conf
cp poky/meta-snake-cm4-qt6/conf/local.conf.example build/conf/local.conf
