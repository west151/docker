...
if ! [ -d $(pwd)/poky ];
 then
   ...
   echo
   git clone -b $YOCTO_BRANCH https://github.com/west151/meta-snake-pi4-qt6 poky/meta-snake-pi4-qt6
   echo
   ...
   # meta-snake-pi4
   echo
   echo -e "${CL_YELLOY}update meta-snake-pi4-qt6:${CL_NC}" $YOCTO_BRANCH
   git -C poky/meta-snake-pi4-qt6 fetch && git -C poky/meta-snake-pi4-qt6 pull origin
   # meta-openembedded
   echo
...
cp poky/meta-snake-pi4-qt6/conf/bblayers.conf.docker build/conf/bblayers.conf
cp poky/meta-snake-pi4-qt6/conf/local.conf.example build/conf/local.conf
